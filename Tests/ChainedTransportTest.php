...
class ChainedTransportTest extends TestCase
{
    public function testSuccessfulChain()
    {
        /** @var TransportInterface|\PHPUnit_Framework_MockObject_MockObject $transport */
        $transport = $this->createMock('ScayTrase\SmsDeliveryBundle\Transport\TransportInterface');
        ...
        $message = $this->createMock('ScayTrase\SmsDeliveryBundle\Service\ShortMessageInterface');
